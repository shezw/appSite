...
class CommerceCoupon extends ASModel{
    ...
    const primaryid = 'uid';
    const addFields = ['uid','saasid','userid','amount','min','max','status','createtime','sort','featured'];
    const updateFields = ['uid','saasid','userid','amount','orderid','min','max','status','createtime','sort','featured'];
    const detailFields = ['uid','saasid','userid','amount','orderid','min','max','status','createtime','sort','featured'];
    const overviewFields = ['uid','saasid','userid','amount','orderid','min','max','status','createtime','sort','featured'];
    const filterFields = ['uid','saasid','userid','amount','orderid','min','max','status','createtime','sort','featured'];
    const depthStruct = [
