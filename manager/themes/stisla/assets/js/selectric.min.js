...
!function(e) {
    ...
    n.prototype = {
        ...
        init: function(t) {
            var s = this;
            if (s.options = e.extend(!0, {}, e.fn.selectric.defaults, s.options, t), s.utils.triggerCallback("BeforeInit", s), s.destroy(!0), s.options.disableOnMobile && s.utils.isMobile())
        ...
        populate: function() {
            ...
            i.length > 1 && t.state.multiple && (n = [], i.each(function() {
                ...
                if (l.is("optgroup")) {
                    ...
                    t.items[s] = t.getItemData(a, l, l.prop("disabled")), t.lookupItems[a] = t.items[s], a++
        ...
        handleKeys: function(t) {
            ...
            if (o && s.state.opened)
                return s.select(u), void (s.state.multiple && s.options.multiple.keepMenuOpen || s.close());
