...
$website->setMenuActive(['coupon',$website->params['status']=='trash' ? 'couponListTrash' : 'couponList']);

$website->setSubData('couponList', $callResult->isSucceed() ? $callResult->getContent()['list'] : null );
