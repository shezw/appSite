...
$getCategory = Category::common()->listByArray(['type'=> Article::alias]);
...
$website->setMenuActive(['templates','templates_edit']);
...
$website->appendTemplateByFile(THEME_DIR.'class/templates/edit.html');
